...
function EditListing() {
  ...
  const onSubmit = async (e) => {
    ...
    const storeImage = async (image) => {
      if (image.size / 1024 > 2000) {//firebase will not take images greater than 2mb

        toast.error('Image could not be uploaded due to exceeding file size of 2mb!')
        return
    ...
    //if no offer then remove the discounted price from object
